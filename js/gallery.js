      ...
      `<div class="hover-card card ${i == 0 ? "border-info" : ""} text-bg-light py-4 px-4 d-flex justify-content-center">
          <div class="row justify-content-evenly align-items-center">
            <div class="col-md-4 col-12 mb-3 mb-md-0">
              <img src="/~sk/images/publications/covers/${publication.cover}" class="rounded-start" alt="27 Publication" width="150px" />
            </div>
            ...
            ${i == 0 ? `<div class="badge rounded-pill text-bg-primary mb-4" style="width: 100px">Latest</div>` : ""}
              ...
              ${publication.fig ? `<img src="/~sk/images/publications/fig/${publication.fig}" class="rounded-start w-100" alt="27 Publication" style="max-width: 800px" />` : ""}
            </div>
            ${
              publication.secondCover
                ? `
            <div class="col-md-4 col-12 mb-3 mb-md-0">
              <img src="/~sk/images/publications/covers/${publication.secondCover}" class="rounded-start" alt="27 Publication" width="150px" />
            </div>`
                : ""
            }
          </div>
